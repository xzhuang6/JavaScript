...
- 工厂模式
    ...
    */
    ...
    var pika = createPerson("皮卡",18);
    var ayuan = createPerson("阿远",19);
    var weige = createPerson("伟哥",20);
    ```
...
- 构造函数模式
    ...
    */
    var pika = new Person("皮卡",18);
    var ayuan = new Person("阿远",19);
    var weige = new Person("伟哥",20);
    ```
...
- 原型模式
    ...
    Person.prototype.university = "外经贸";
